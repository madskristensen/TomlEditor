...
namespace TomlEditor
{
    ...
    /// document outline support for TOML files in the Document Outline tool window.
    /// </summary>
    [ComVisible(true)]
    internal class TomlCodeWindowManager : CodeWindowManager, IVsDocOutlineProvider
    {
